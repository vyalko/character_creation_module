...
"""This retro game code."""


def attack(char_name: str, char_class: str) -> str:
    """Depending on the choice of character class.
...
def defence(char_name: str, char_class: str) -> str:
    """Depending on the choice of character class.
    Blocks the corresponding damage.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Select your character class and start training."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Select and confirm a character class."""
    approve_choice: str = ''
    char_class: str = ''
