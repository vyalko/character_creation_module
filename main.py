...
class Character:
    ...
    def attack(self):
        ...
        value_attack = DEFAULT_ATTACK + randint(
    ...
    def deffence(self):
        ...
        value_defence = DEFAULT_DEFENCE + randint(
    ...
    def special(self):
        return (f'{self.name} применил специальное умение '
                f'"{self.SPECIAL_SKILL} {self.SPECIAL.BUFF}".')
...
def start_training(character):
    ...
    # Добавили словарь, в котором содержатся команды тренировки.
